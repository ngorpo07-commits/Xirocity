...
SWEP.PrintName = "Franchi SPAS-12M"
...
SWEP.WepSelectIcon2 = Material("vgui/spas12m.png")
SWEP.IconOverride = "vgui/spas12m.png"
...
function SWEP:Reload(time)
	...
	if SERVER then
		self:SetNetVar("shootgunReload",CurTime() + (self:Clip1() == 0 and 3.1 or 1.3))
		
		local anim = self:Clip1() == 0 and "start_empty" or "start"
		self:PlayAnim(self.AnimList[anim] or "sgreload_start",self:Clip1() == 0 and 3 or 1.1,false,function() 
			self:SetNetVar("shootgunReload",CurTime() + 1.3)
