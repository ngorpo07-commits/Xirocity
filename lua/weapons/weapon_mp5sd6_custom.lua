...
SWEP.PrintName = "HK MP5SD6 Custom"
...
if CLIENT then
	...
	SWEP.FakeReloadEvents = {
		...
		[0.22] = function( self, timeMul )
			self:GetOwner():PullLHTowards("ValveBiped.Bip01_Spine2", 0 * timeMul,nil,nil,function() 
...
SWEP.WepSelectIcon2 = Material("vgui/mp5sd6c.png")
SWEP.IconOverride = "vgui/mp5sd6c.png"

SWEP.CustomShell = "9x19"
--SWEP.EjectPos = Vector(0,-20,5)
--SWEP.EjectAng = Angle(0,90,0)

SWEP.LocalMuzzlePos = Vector(17.706,-0.488,3.525)
...
SWEP.availableAttachments = {
	...
	underbarrel = {
		...
		["mount"] = {["picatinny_small"] = Vector(7, -0.15, 0.3)},
		["mountAngle"] = {["picatinny_small"] = Angle(0, 0, -2.5)},
...
SWEP.StartAtt = {"holo14","grip3","laser2"}
