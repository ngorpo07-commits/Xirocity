...
SWEP.WepSelectIcon2 = Material("vgui/mp5k.png")
SWEP.IconOverride = "vgui/mp5k.png"
...
SWEP.animposmul = 2
SWEP.Primary.Sound = {"weapons/mp40/mp40_fp.wav", 75, 120, 130}
...
SWEP.holsteredPos = Vector(-11.6, 1, -1)
SWEP.holsteredAng = Angle(210, 170, 100)
