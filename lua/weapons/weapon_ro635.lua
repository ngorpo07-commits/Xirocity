...
SWEP.PrintName = "RO-635"
SWEP.Author = "Colt's Manufacturing Company"
SWEP.Instructions = "AR15 chambered in 9x19 mm"
...
SWEP.FakePos = Vector(-12, 3.5, 6.5)
SWEP.FakeAng = Angle(0, 0, 0.0)
SWEP.AttachmentPos = Vector(3.8,2.1,-27.8)
SWEP.AttachmentAng = Angle(0,0,0)
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "0360442700030"
SWEP.ZoomPos = Vector(0, 0.6856, 5.1747)
...
SWEP.WepSelectIcon2 = Material("vgui/inventory/No6951.png")
SWEP.IconOverride = "vgui/inventory/No6951.png"
...
SWEP.availableAttachments = {
	...
	sight = {
		...
		["mount"] = {ironsight = Vector(-17, 1.2, 0.05), picatinny = Vector(-18.9, 1.25, 0.04)},
		["removehuy"] = {
			[1] = "null"
		}
	},
...
SWEP.LocalMuzzlePos = Vector(20,0.7,2.7)
...
SWEP.LHandPos = false
SWEP.SprayRand = {Angle(-0.00, -0.01, 0), Angle(-0.00, 0.01, 0)}
SWEP.Ergonomics = 0.9
SWEP.Penetration = 7
