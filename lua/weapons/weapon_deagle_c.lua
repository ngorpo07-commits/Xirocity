...
SWEP.PrintName = "Desert Eagle Compensated"
...
function SWEP:InitializePost()
	...
	self:SetDeagleBodygroup(math.random(0,2))
end
	...
	SWEP.FakeReloadEvents = {
		...
		[0.33] = function( self, timeMul ) 
			...
			if self:Clip1() > 0 then
				self:GetOwner():PullLHTowards("ValveBiped.Bip01_L_Thigh", 0 * timeMul,nil,nil,function()
					self:GetWM():ManipulateBoneScale(48, vector_full)
					for i = 49, 55 do
						self:GetWM():ManipulateBoneScale(i, vector_full)
					end
...
SWEP.WepSelectIcon2 = Material("vgui/deaglec.png")
SWEP.IconOverride = "vgui/deaglec.png"
