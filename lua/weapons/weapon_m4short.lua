...
SWEP.WepSelectIcon2 = Material("vgui/m4supersh.png")
SWEP.IconOverride = "vgui/m4supersh.png"
...
SWEP.availableAttachments = {
	...
	barrel = {
		[1] = {"supressor5", Vector(-7.5,0,0.2), {}},
	}
}

SWEP.holsteredBone = "ValveBiped.Bip01_Pelvis"
SWEP.holsteredPos = Vector(-13.6, 6, 0)
...
function SWEP:Reload(time)
	...
	--self:GetWM():ManipulateBoneScale(47, vector_full)
	if SERVER then
		self:SetNetVar("shootgunReload",CurTime() + (self:Clip1() == 0 and 1.6 or 0.75))
		
		local anim = self:Clip1() == 0 and "start_empty" or "start"
		self:PlayAnim(self.AnimList[anim] or "sgreload_start",self:Clip1() == 0 and 1.5 or 0.65,false,function() 
			self:SetNetVar("shootgunReload",CurTime() + 0.75)
