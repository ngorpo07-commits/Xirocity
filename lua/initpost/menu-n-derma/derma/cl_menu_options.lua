...
local hg_firstperson_death = CreateClientConVar("hg_firstperson_death", "0", true, false, "Переключить вид камеры смерти от первого лица", 0, 0)
local hg_font_default = "Lora"
local hg_font = ConVarExists("hg_font") and GetConVar("hg_font") or CreateClientConVar("hg_font", hg_font_default, true, false, "Изменить шрифт текста на выбранный (кастомизация UI — это круто)", 0, 1)
local hg_oldradialmenu = CreateClientConVar("hg_oldradialmenu", "0", true, false, "Использовать старый стиль радиального меню", 0, 1)
local hg_nojogging = CreateClientConVar("hg_nojogging", "0", true, true, "Автоматический бег при зажатии Shift.", 0, 1)
local hg_gollavo_headshot_effect = ConVarExists("hg_gollavo_headshot_effect") and GetConVar("hg_gollavo_headshot_effect") or CreateClientConVar("hg_gollavo_headshot_effect", "1", true, false, "Включить эффект попадания в голову Gollavo", 0, 1)
...
local hg_attachment_draw_distance = CreateClientConVar("hg_attachment_draw_distance", 0, true, nil, "Дистанция прорисовки обвесов", 0, 4096)
...
hg.settings:AddOpt("Геймплей","hg_newthoughts", "Новые мысли")
hg.settings:AddOpt("Геймплей","hg_showthoughts", "Показывать мысли")
hg.settings:AddOpt("Геймплей","hg_hints", "Показывать подсказки")
hg.settings:AddOpt("Геймплей","hg_gary", "HG GARY")
hg.settings:AddOpt("Геймплей","hg_deathfadeout", "Затемнение при смерти")
hg.settings:AddOpt("Геймплей","hg_nojogging", "Отключить легкий бег")
hg.settings:AddOpt("Геймплей","deatheffect_death_screen", "Кинематографичный экран смерти")
if not game.IsDedicated() then
	hg.settings:AddOpt("Серверный геймплей","hg_toughnpcs", "Усиленные NPC")
	hg.settings:AddOpt("Серверный геймплей","hg_thirdperson", "Вид от третьего лица (В разработке)")
	hg.settings:AddOpt("Серверный геймплей","hg_legacycam", "Старая камера")
	hg.settings:AddOpt("Серверный геймплей","hg_ragdollcombat", "Режим боя регдоллов")
	hg.settings:AddOpt("Серверный геймплей","hg_movement_stamina_debuff", "Штраф к выносливости при передвижении")
	...
	hg.settings:AddOpt("Серверный геймплей","hg_aimtoshoot", "Система стрельбы как в DarkRP (прицелься для стрельбы)")
	hg.settings:AddOpt("Серверный геймплей","hg_slings", "Система оружейных ремней")
    hg.settings:AddOpt("Серверный геймплей","homicide_traitoramount", "Homicide: Количество предателей", nil, nil, "int")
end

hg.settings:AddOpt("Отладка","hg_show_hitposmuzzle", "Показывать точку попадания оружия")
hg.settings:AddOpt("Отладка","hg_setzoompos", "Редактировать позицию зума оружия (проверьте консоль)")
hg.settings:AddOpt("Отладка","hg_show_hitbox", "Показывать хитбоксы")

hg.settings:AddOpt("Оптимизация","hg_potatopc", "Режим для слабых ПК")
hg.settings:AddOpt("Оптимизация","hg_anims_draw_distance", "Дистанция прорисовки анимаций", true, nil, "int")
hg.settings:AddOpt("Оптимизация","hg_anim_fps", "FPS анимаций", nil, nil, "int")
hg.settings:AddOpt("Оптимизация","hg_attachment_draw_distance", "Дистанция прорисовки обвесов", true, nil, "int")
hg.settings:AddOpt("Оптимизация","hg_maxsmoketrails", "Максимум дымовых следов", nil, nil, "int")
...
hg.settings.tbl["Интерфейс"] = hg.settings.tbl["Интерфейс"] or {}
hg.settings.tbl["Интерфейс"]["hg_font"] = nil
hg.settings:AddOpt("Интерфейс","hg_oldradialmenu", "Старое радиальное меню")
...
hg.settings:AddOpt("Оружие","hg_highpitchgunfire", "Высокие звуки выстрелов внутри зданий")
hg.settings:AddOpt("Оружие","hg_gollavo_headshot_effect", "Эффект попадания в голову Gollavo")

hg.settings:AddOpt("Вид","hg_fov", "Угол обзора (FOV)")
hg.settings:AddOpt("View","hg_newspectate", "Плавная камера наблюдателя")
hg.settings:AddOpt("Вид","hg_cshs_fake", "Камера регдолла C'sHS")
hg.settings:AddOpt("Вид","hg_gun_cam", "Камера на оружии (ТОЛЬКО ДЛЯ АДМИНОВ)")
hg.settings:AddOpt("Вид","hg_nofovzoom", "Включить/Отключить приближение FOV")
hg.settings:AddOpt("Вид","hg_realismcam", "Камера реализма (плохая)")
hg.settings:AddOpt("Вид","hg_gopro", "Камера GoPro")
hg.settings:AddOpt("Вид","hg_newfakecam", "Новая фейк-камера")
hg.settings:AddOpt("Вид","hg_leancam_mul", "Множитель наклона камеры", true, nil, "int")
hg.settings:AddOpt("Вид","hg_gun_cam", "Камера на оружии (В разработке, только админы)")
hg.settings:AddOpt("Звук","hg_dmusic", "Динамическая музыка")
hg.settings:AddOpt("Звук","hg_quietshots", "Включить/Отключить тихие звуки выстрелов")
...
local info_sections = {
    {title = "Звание", key = "rank"},
    {title = "Таблица лидеров", key = "leaderboard"},
    {title = "Создатели", key = "credits", disabled = true, disabledColor = Color(105, 105, 105, 180)},
    {title = "Соцсети", key = "socials"}
}
...
local info_social_links = {
    {
        title = "Lapse",
        subtitle = "В суждении. (Официальный сервер сообщества)",
        url = DISCORD_URL or "https://discord.gg/Tgz7N58PzV",
        icon = Material("vgui/lapseinjudgement.png", "smooth")
    },
    {
        title = "Англоязычный сервер Z-CITY",
        subtitle = "Официальный сервер сообщества для репозитория Z-CITY (ENG)",
        url = "https://discord.gg/SjqRcv3yYY",
        icon = Material("vgui/zcityeng.png", "smooth")
    },
    {
        title = "Русскоязычный сервер Z-CITY",
        subtitle = "Официальный сервер сообщества для репозитория Z-CITY (RUS)",
        url = "https://discord.gg/475EmEdTgH",
        icon = Material("vgui/zcityrus.png", "smooth")
    },
    {
        title = "Центр сообщества (СЕРВЕР RENCHDEDSEX'S ZCITY)",
        subtitle = "Если вы ищете ЛУЧШУЮ альтернативу ближе к ванильной версии.",
...
function hg.DrawSettings(ParentPanel)
    ...
    for categoryName, _ in pairs(hg.settings.tbl) do
        if (categoryName == "Отладка" or categoryName == "Серверный геймплей") and not isSuperAdmin then
            continue
        end
    ...
    sidebarHeaderTitle:SetText("НАСТРОЙКИ")
    ...
    backBtn:SetText(string.rep("#", #"<- Назад"))
    ...
    headerTitle:SetText(settings_active_category and settings_active_category:upper() or "НАСТРОЙКИ")
...
local function KeybindsFormatKey(key)
    if not key or key == KEY_NONE or key == -999 then return "НЕТ" end
...
local function KeybindsCreateBinder(parent, bindName, slot, x, y)
    ...
    function binder:Paint(w, h)
        ...
        surface.DrawOutlinedRect(0, 0, w, h, 1)
        draw.SimpleText(self.Trapping and "НАЖМИТЕ КЛАВИШУ" or KeybindsFormatKey(self:GetValue()), "ZCity_Menu_Settings_Tiny", w / 2, h / 2, settings_color_text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        return true
    end
...
function KeybindsRefreshContent()
    ...
    if IsValid(keybinds_header_label) then
        keybinds_header_label:SetText("НАЗНАЧЕНИЕ КЛАВИШ")
    end
    ...
    for bindName, bindData in SortedPairs(hg.Binds.CurrentBinds or {}) do
        ...
        clear.Paint = function(self, w, h)
            ...
            surface.SetDrawColor(settings_color_whitey.r, settings_color_whitey.g, settings_color_whitey.b, self:IsHovered() and 210 or 120)
            surface.DrawOutlinedRect(0, 0, w, h, 1)
            draw.SimpleText("Сбросить", "ZCity_Menu_Settings_Tiny", w / 2, h / 2, settings_color_text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        end
...
function hg.DrawKeybinds(ParentPanel)
    ...
    headerTitle:SetFont("ZCity_Menu_Settings_Medium")
    headerTitle:SetTextColor(settings_color_whitey)
    headerTitle:SetText("НАЗНАЧЕНИЕ КЛАВИШ")
    ...
    headerHint:SetFont("ZCity_Menu_Settings_Tiny")
    headerHint:SetTextColor(settings_color_text_dim)
    headerHint:SetText("Если клавиши уже забинжены через консоль, вы всё равно можете использовать их как альтернативные.")
    headerHint:SizeToContents()
    ...
    resetBtn.Paint = function(self, w, h)
        ...
        surface.SetDrawColor(settings_color_whitey.r, settings_color_whitey.g, settings_color_whitey.b, self:IsHovered() and 210 or 120)
        surface.DrawOutlinedRect(0, 0, w, h, 1)
        draw.SimpleText("Сбросить по умолч.", "ZCity_Menu_Settings_Tiny", w / 2, h / 2, settings_color_text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end
...
function InfoRefreshContent()
    ...
    if sectionKey == "rank" then
        ...
        achievementsEmpty:SetText("НЕТ ПОЛУЧЕННЫХ ДОСТИЖЕНИЙ")
        ...
        local function RefreshAchievements()
            ...
            for _, ach in ipairs(obtained) do
                ...
                title:SetFont("ZCity_Menu_Settings_Small")
                title:SetTextColor(settings_color_text)
                title:SetText(ach.name or "Достижение")
                title:SizeToContents()
        ...
        card.Think = function()
            ...
            if lastExp ~= newExp or lastSkill ~= newSkill then
                ...
                xpLabel:SetText(newExp .. " Опыта")
                skillLabel:SetText(newSkill .. " Навык")
                medalLabel:SetText("Медаль: " .. string.upper((medal and medal.name) or "БЕЗ РАНГА"))
                bandLabel:SetText("Лента: " .. ((band and band.name and band.name ~= "") and string.upper(band.name) or "СКОРО"))
                lastExp = newExp
                lastSkill = newSkill
    ...
    elseif sectionKey == "leaderboard" then
        ...
        local function RebuildRows()
            ...
            if #leaders == 0 then
                ...
                empty:SetText("НЕТ ДАННЫХ SQL ТАБЛИЦЫ ЛИДЕРОВ")
                rows[#rows + 1] = empty
                return
            end
            ...
            for rank, data in ipairs(leaders) do
                ...
                row.Paint = function(self, w, h)
                    ...
                    draw.SimpleText(string.format("К/Д %.2f", self.PlayerData.kd), "ZCity_Menu_Settings_Tiny", MenuUnit(96), MenuUnit(43), settings_color_text_dim, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
                    ...
                    draw.SimpleText("У " .. math.floor(self.PlayerData.kills) .. "  С " .. math.floor(self.PlayerData.deaths), "ZCity_Menu_Settings_Tiny", w - MenuUnit(18), MenuUnit(43), settings_color_text_dim, TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
                end
    ...
    elseif sectionKey == "socials" then
        ...
        alsoCheck:SetText("Также посетите:")
        ...
        for _, social in ipairs(info_social_links) do
            ...
            row.Paint = function(self, w, h)
                ...
                draw.SimpleText("Войти", "ZCity_Menu_Settings_Tiny", buttonX + buttonW * 0.5, buttonY + buttonH * 0.5, settings_color_whitey, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
            end
        end
    end
end
...
function hg.DrawInformation(ParentPanel)
    ...
    sidebarHeaderTitle:SetTextColor(settings_color_whitey)
    sidebarHeaderTitle:SetText("ИНФОРМАЦИЯ")
    sidebarHeaderTitle:SizeToContents()
    sidebarHeaderTitle.OpenTime = CurTime()
    function sidebarHeaderTitle:Think()
        local elapsed = CurTime() - (self.OpenTime or CurTime())
        local charsToShow = math.floor(elapsed * 18)
        local target = "ИНФОРМАЦИЯ"
        local len = #target
        if charsToShow > len then charsToShow = len end
       if self.TypewriterTarget ~= target then
    self.TypewriterTarget = target
    ...
    headerHint:SetFont("ZCity_Menu_Settings_Tiny")
    headerHint:SetTextColor(settings_color_text_dim)
    headerHint:SetText("Просмотр ранга и ссылок на соцсети")
    headerHint:SizeToContents()
